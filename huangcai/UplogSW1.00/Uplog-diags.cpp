				...
				while(1)
				{
					...
					if(iT==iN+1)
					{
						...
						if(bIsHaveNo == FALSE)
						{
							...
							char szB[550]="(ID COUNTER (1, 1),";/*SN TEXT,STATION TEXT,90SN TEXT,MBPPID TEXT,MAC TEXT,BIOSTEMP TEXT,USERCRC TEXT,RECCRC TEXT,CPUMODEL TEXT,CPUTEST TEXT,MEMOK TEXT,1394ID TEXT,USBCHK TEXT,PCICHK TEXT,MOUSECHK TEXT,AUDIOTEST TEXT,1394TEST TEXT,JDTEST TEXT,CVID TEXT,HDD1MODE TEXT,CHKREGOK TEXT,LEDCHK TEXT,USBCABLE TEXT,FTOK TEXT,RGB TEXT,LSCRIBLE TEXT,DVDOK TEXT,CDOK TEXT,ODDROM TEXT,WLANCHK TEXT,BDTEST TEXT,WRESTEST TEXT,HDMITEST TEXT,IRTEST TEXT,MODEMCHK TEXT,BUTTEST TEXT,TVTEST TEXT,SUSPEND TEXT,CARDTEST TEXT,WINTEST TEXT,TESTPASS TEXT,DT DATETIME*/
							for(int i=0;i<iN;i++)
							{
								//if(i=0)
								//{
								//	strcat(szB,szTemN[i]);
								//	strcat(szB," COUNTER (1, 1),");
								//}
								//else
								//{
									strcat(szB,szTemN[i]);
