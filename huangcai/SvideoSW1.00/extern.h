...
extern int NO;
extern BOOL blCPUexit;
extern BOOL blMemoryexit;
extern int nErrorLevel;
extern	LONG64 l64ExecTime;
extern	LONG64 l64Timer;
extern Boolean blNoLogo;
extern Boolean blClearScreen;
extern Boolean blParameterOK;
extern Boolean blResult;
//extern char DevN[10240000];
extern BOOL blexit;
extern HWND wndHandle;
extern HWND g_hwnd[3];
//extern char szTem[100];